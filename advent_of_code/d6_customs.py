...
grouped_answers = [[p for p in g.split("\n") if p] for g in all_answers.split("\n\n")]

# Part 1
print(sum([len(set(g.replace("\n", ""))) for g in all_answers.split("\n\n")]))

# Part 2
from functools import reduce
print(sum([len(reduce(lambda x, y: set(x).intersection(y), g)) for g in grouped_answers]))
